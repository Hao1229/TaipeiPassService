...
<template>
  <div class="base-select-wrapper">
    <select v-bind="$attrs" :id="props.selectId" v-model="inputValue" class="base-select">
      <option v-if="props.defaultSelected" value="" selected>{{ props.defaultSelected }}</option>
